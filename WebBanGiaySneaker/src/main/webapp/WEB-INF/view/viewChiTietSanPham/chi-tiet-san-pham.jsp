...
<div class="row">
    ...
    <form:form method="post" action="/chi-tiet-san-pham/addOrUpdate" modelAttribute="chiTietSanPham" enctype="multipart/form-data">
        ...
        <div class="row">
            ...
            <div class="col-3">
                Ảnh:<br><input type="file" name="anh" accept="image/*" class="form-control-file" onchange="previewImage(event)"/>
                <br>

...
<div class="row">
    <div class="col-4" style="border: solid black">
        ...
        <a href="/login" class="btn btn-outline-primary" role="button">Đăng ký tài khoản</a> | <a class="btn btn-outline-success" role="button" href="/login">Đăng nhập</a>
        <br>
        <br>
        <h5>Mua hàng không cần tài khoản</h5>
        <form:input path="tenNguoiNhan" placeholder="Họ & tên" class="form-control" title="Vui lòng chỉ sử dụng chữ cái" required="true"/> <br>
<%--        <form:errors path="tenNguoiNhan" cssClass="text-danger"/> <br>--%>
        <form:input type="text" path="sdt" placeholder="Số điện thoại" class="form-control" pattern="[0-9]{10}" title="Vui lòng chỉ sử dụng số, nhập đủ 10 số" required="true"/> <br>
...
<%--        <form:errors path="email" cssClass="text-danger"/> <br>--%>
        <form:input path="diaChi" placeholder="Địa chỉ" class="form-control" title="Vui lòng chỉ sử dụng chữ cái và số, tối đa 10 ký tự" required="true"/> <br>
<%--        <form:errors path="diaChi" cssClass="text-danger"/> <br>--%>
    ...
    <div class="col-4" style="border: solid black">
        ...
        <h5>Thanh toán</h5>
        <input:radiobutton path="hinhThucThanhToan"  value="Chuyển khoản momo"  onclick="showImage('momo.jpg')"  /> Chuyển khoản momo <br>
        <input:radiobutton path="hinhThucThanhToan"  value="Chuyển khoản ngân hàng"  onclick="showImage('viettin.jpg')"/> Chuyển khoản ngân hàng <br>
        <input:radiobutton path="hinhThucThanhToan"  value="Thanh toán khi nhận hàng"  onclick="showImage('thanh-toan-khi-nhan-hang.jpg')" checked="true" /> Thanh toán khi nhận hàng <br>
    ...
    <div class="col-4" style="border: solid black">
        ...
        <c:forEach items="${cart}" var="cart">
            <div>
                <h5>  <img style="width: 100px; height: 100px" src="../images/${cart.anh}">x ${cart.soLuong} <p style="float: right">${cart.soLuong * cart.gia}đ</p></h5>
            </div>
            <hr>
...
<%--        <button style="float: right" class="btn btn-dark" type="submit">Đặt hàng</button>--%>
        <form:button style="float: right" class="btn btn-dark" type="submit" onClick="return datHang()">Đặt hàng</form:button>
    </div>
</div>
</form:form>

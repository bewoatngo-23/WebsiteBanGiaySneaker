    ...
    <div class="form-container sign-up-container">
        ...
        <form:form action="/login/sign-up" method="post" modelAttribute="khachHang">
            ...
            <div class="social-container">
                ...
                <a href="<c:url value="/login/google" />" class="social"><i class="fab fa-google-plus-g"></i></a>
            ...
            <form:input path="matKhau" type="password" placeholder="Password"  pattern="[a-zA-Z0-9]{0-9}" title="vui lòng nhập đúng định dạng" required="true"/>
